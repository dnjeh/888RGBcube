...
void firework() {
  ...
  while(millis() - start < 20000) {
    ...
    a[ind%2][2]=random(1, 7);
    a[ind%2][3]=random(1, 7);
    ...
    for(int i=0;i<3*(a[ind%2][4]+1);i++) {
      ...
      LED(i/3, a[ind%2][3], a[ind%2][2], a[ind%2][5], a[ind%2][6], a[ind%2][7]);
      
      for(int ii=0;ii<i/3;ii++) {
        LED(ii, a[ind%2][3], a[ind%2][2], a[ind%2][5]-i/3+ii, a[ind%2][6]-i/3+ii, a[ind%2][7]-i/3+ii);
      }

      LED(a[(ind+1)%2][4], a[(ind+1)%2][3], a[(ind+1)%2][2], a[(ind+1)%2][5]-i+3, a[(ind+1)%2][6]-i+3, a[(ind+1)%2][7]-i+3);
      if(a[(ind+1)%2][1]&1) {
        for(int t=a[(ind+1)%2][0]*-1;t<=a[(ind+1)%2][0];t++) {
          if(!t) continue;
          if(a[(ind+1)%2][4]+t>=0&&a[(ind+1)%2][4]+t<8) {
            LED(a[(ind+1)%2][4]+t, a[(ind+1)%2][3], a[(ind+1)%2][2], a[(ind+1)%2][5]-i+3, a[(ind+1)%2][6]-i+3, a[(ind+1)%2][7]-i+3);
          }
          if(a[(ind+1)%2][3]+t>=0&&a[(ind+1)%2][3]+t<8) {
            LED(a[(ind+1)%2][4], a[(ind+1)%2][3]+t, a[(ind+1)%2][2], a[(ind+1)%2][5]-i+3, a[(ind+1)%2][6]-i+3, a[(ind+1)%2][7]-i+3);
          }
          if(a[(ind+1)%2][2]+t>=0&&a[(ind+1)%2][2]+t<8) {
            LED(a[(ind+1)%2][4], a[(ind+1)%2][3], a[(ind+1)%2][2]+t, a[(ind+1)%2][5]-i+3, a[(ind+1)%2][6]-i+3, a[(ind+1)%2][7]-i+3);
          }
        }
      }
      ...
      if(a[(ind+1)%2][1]&2) {
        for(int t=a[(ind+1)%2][0]*-1;t<=a[(ind+1)%2][0];t++) {
          ...
          if(a[(ind+1)%2][3]+t>=0&&a[(ind+1)%2][3]+t<8&&a[(ind+1)%2][2]+t>=0&&a[(ind+1)%2][2]+t<8) {
            LED(a[(ind+1)%2][4]-t, a[(ind+1)%2][3]+t, a[(ind+1)%2][2]+t, a[(ind+1)%2][5]-i+3, a[(ind+1)%2][6]-i+3, a[(ind+1)%2][7]-i+3);
          }
          if(a[(ind+1)%2][3]-t>=0&&a[(ind+1)%2][3]-t<8&&a[(ind+1)%2][2]+t>=0&&a[(ind+1)%2][2]+t<8) {
            LED(a[(ind+1)%2][4]-t, a[(ind+1)%2][3]-t, a[(ind+1)%2][2]+t, a[(ind+1)%2][5]-i+3, a[(ind+1)%2][6]-i+3, a[(ind+1)%2][7]-i+3);
          }
